            ...
            <div class="card-body">
                <form method="POST" action="{{ route('personnel.store') }}">
                    ...
                    <div class="form-group form-control-lg">
                        ...
                        <input type="text" name="carte_identite" id="carte_identite" class="form-control @error('carte_identite') is-invalid @enderror" value="{{ old('carte_identite') }}" required>
                    ...
                    <div class="form-group form-control-lg">
                        ...
                        <input type="text" name="horaires_travail" id="horaires_travail" class="form-control @error('horaires_travail') is-invalid @enderror" value="{{ old('horaires_travail') }}" required>
                    ...
                    <div class="form-group form-control-lg">
                        ...
                        <input type="text" name="cjm" id="cjm" class="form-control @error('cjm') is-invalid @enderror" value="{{ old('cjm') }}" required>
                        @error('cjm')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
